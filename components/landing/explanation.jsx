export default function LandingExplanation ({block, dataBinding}) {
    return (
        ...
        <h1 className="section-header">How the Twin Health program works</h1>
        <div className="three-column">
            <div className="how-it-works__content-block">
                ...
                <div className="how_it_work_description">Speak with a Twin Health enrollment advisor who will assess your
            ...
            <div className="how-it-works__content-block">
                ...
                <div className="how_it_work_description">Download the Twin Health app, set up your health profile and complete a
            ...
            <div className="how-it-works__content-block">
                ...
                <div className="how_it_work_description">Once verified, you will meet your Twin Health care team through video
